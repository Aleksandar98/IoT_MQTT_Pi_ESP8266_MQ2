...
int i = 0;
#define pin 4 // Digital pin connected to your sensor
int trueReadingsInRow = 0;
String msg ="";
// WiFi
// Make sure to update this for your own WiFi network!
const char* ssid = "GalaxyS21Aca";
const char* wifi_password = "yexw4127";

// MQTT
// Make sure to update this for your own MQTT Broker!
const char* mqtt_server = "192.168.198.54";
const char* mqtt_topic = "sensors";
// The client id identifies the ESP8266 device. Think of it a bit like a hostname (Or just a name, like Greg).
const char* clientID = "ClientESP8266";
...
//  if(client.publish(mqtt_topic, "temp,site=room1 value=29")){
...
//  delay(2000);
 ...
 if(!digitalRead(pin))
    ...
    if(trueReadingsInRow == 10){
      
      Serial.println("DANGER");
      client.publish(mqtt_topic, "temp,site=room1 value=29");
      trueReadingsInRow = 0;
    }
    delay(1000);
